...
public class BaseTemplate {
    ...
    public String resMatch(String resText,String pattern){
        java.util.regex.Pattern ExpPattern = java.util.regex.Pattern.compile(pattern , java.util.regex.Pattern.DOTALL);
